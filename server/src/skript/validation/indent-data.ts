                ...
                if (indentationString[0] == inverseExpectedIndentationCharacter) {
                    context.addDiagnostic(
                        ...
                        `indentation error: expected ` +
                            currentExpectedIndentationcharacterCount +
                            (this.unit[0] == " " ? " space" : " tab") +
                            (currentExpectedIndentationcharacterCount == 1 ? "" : "s") +
                            ` but found ` +
                            this.endIndex +
                            (indentationString[0] == " " ? " space" : " tab") +
                            (indentationString.length == 1 ? "" : "s"),
                        DiagnosticSeverity.Error,
                    ...
                    if (
                        this.endIndex > currentExpectedIndentationcharacterCount ||
                        this.endIndex % this.unit.length != 0
                    ) {
                        ...
                        if (indentationString == "") this.unit = "";
