...
describe("sortedIndex", () => {
    test("should find the correct index for insertion", () => {
        const arr = [1, 3, 5, 7, 9];
    ...
    test("should return array length for value larger than all elements", () => {
        const arr = [1, 2, 3];
...
describe("insertSorted", () => {
    test("should insert value at correct position", () => {
        const arr = [1, 3, 5];
        insertSorted(arr, 4, (a, b) => a < b);
        expect(arr).toEqual([1, 3, 4, 5]);
    });

    test("should maintain sorted order after multiple insertions", () => {
        const arr: number[] = [];
...
describe("getMaxElement", () => {
    ...
    test("should return the initial value for empty array", () => {
        const arr: number[] = [];
        const result = getMaxElement(arr, 0, (a, b) => a < b);
        expect(result).toBe(0);
    });
